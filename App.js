  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity 
          style={[styles.button, { backgroundColor: VUT_MAROON }]} 
          onPress={navigateToVUT}
        >
          <Text style={[styles.buttonText, { color: VUT_GOLD }]}>Navigate to VUT</Text>
        </TouchableOpacity>

        <TouchableOpacity 
          style={[styles.button, { backgroundColor: VUT_GOLD }]} 
          onPress={() => setShowCampusMap(true)}
        >
      ...
      <Modal visible={showCampusMap} animationType="slide">
        <View style={styles.modalContainer}>
          ...
          <ScrollView>
            <Image 
              source={{ uri: 'https://i.imgur.com/YourImageLinkHere.png' }} 
