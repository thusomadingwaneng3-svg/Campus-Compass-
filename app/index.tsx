...
import { View, Text, TouchableOpacity, StyleSheet, TextInput, Modal, Linking, SafeAreaView, StatusBar, ScrollView, Platform } from 'react-native';
...
// Combine all 3 arrays = 90 institutions total
const ALL_CAMPUSES_APPLY = [
...
export default function InstitutionsScreen() {
  ...
  const filtered = ALL_CAMPUSES_APPLY.filter(c => 
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>ALL {ALL_CAMPUSES_APPLY.length} SA INSTITUTIONS</Text>
        <Text style={styles.subHeader}>Map • Emergency • Apply • APS</Text>
        
        {/* Install button - only shows on web when installable */}
        {canInstall && (
      ...
      <TextInput
        style={styles.search}
        placeholder="Search university, TVET, private college, or city..."
      ...
      <ScrollView style={{ paddingHorizontal: 12 }}>
        <Text style={styles.notice}>
          Applications for 2026. Most close 30 Sept 2025. Data verified May 2, 2026.
        </Text>
        
        {filtered.length === 0 && (
          <Text style={styles.noResults}>No institutions found for "{search}"</Text>
        )}
